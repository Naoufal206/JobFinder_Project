...
![JobFinder Sign In](screenshots/login.jpg)

#### Create Account

![JobFinder Create Account](screenshots/create-account.jpg)

---

### 💼 Job Listings

![JobFinder Job Listings](screenshots/job-listings.jpg)

---

### 📝 Job Application

![JobFinder Application Form](screenshots/job-application.jpg)

Candidates can review the selected position, salary, location, requirements, and description before submitting their application and CV.

---

### 📊 HR / Company Dashboard

![JobFinder Admin Dashboard](screenshots/admin-dashboard.jpg)

The dashboard provides an overview of published roles, applications, interviews, and accepted candidates.

---

### 👥 Applications Management

![JobFinder Applications](screenshots/applications-overview.jpg)

HR users can review applicants, open or preview resumes, schedule interviews, reject candidates, and accept qualified applicants.

---

### 📅 Schedule Interview

![JobFinder Schedule Interview](screenshots/schedule-interview.jpg)

HR users can schedule an interview by providing the date, time, and meeting location or link.

---

### 📧 Candidate Acceptance

![JobFinder Accept Candidate](screenshots/accept-candidate.jpg)

Accepted candidates can receive an email containing their hiring/start-work information.

---

### 👤 Profile

![JobFinder Profile](screenshots/profile.jpg)

Applicants can manage their personal information and monitor profile completeness.

---

### 📌 Application Tracker

![JobFinder My Applications](screenshots/my-applications.jpg)

Applicants can track their applications and see statuses such as:
